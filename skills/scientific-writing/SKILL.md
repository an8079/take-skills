...
description: "Core skill for deep research and scientific writing. Write manuscripts in full paragraphs (never bullet points). Two-stage process: (1) section outlines with key points, (2) convert to flowing prose. IMRAD structure, citations (APA/AMA/Vancouver), figures/tables, reporting guidelines (CONSORT/STROBE/PRISMA). Supports journal manuscripts and professional reports."
...
**This is the core skill for deep research and scientific writing**—combining AI-driven deep research with well-formatted written outputs. Every document produced is backed by comprehensive literature search and verified citations.
...
- Creating professional research reports, white papers, and technical documents

## Visual Enhancement with Scientific Schematics

**Every scientific paper MUST include a graphical abstract plus 1-2 additional AI-generated figures.**

Scientific papers without visual elements are incomplete. Before finalizing any document:
1. **ALWAYS generate a graphical abstract** as the first visual element
2. Generate at minimum ONE additional schematic or diagram
...
- **NEVER** use labeled sections (Background:, Methods:, Results:, Conclusions:) unless journal explicitly requires it
...
2. For each section below, follow the two-stage process:
   - **First**: Create outline with bullet points

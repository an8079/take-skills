...
```bash
# 1. 确认插件路径
# Windows: %USERPROFILE%\.claude\plugins\claude-studio
# macOS/Linux: ~/.claude/plugins/claude-studio

# 2. 检查文件是否存在
ls ~/.claude/plugins/claude-studio/CLAUDE.md
...
```bash
# 检查插件安装
ls -la ~/.claude/plugins/claude-studio/

# 检查文件内容
cat ~/.claude/plugins/claude-studio/CLAUDE.md

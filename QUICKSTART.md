# Claude Studio 快速开始指南

> 让你在 5 分钟内上手 Claude Studio

---

## 第一步：安装 Claude Studio
...
# Windows
xcopy /E /I claude-studio %USERPROFILE%\.claude\plugins\claude-studio

# macOS/Linux
cp -r claude-studio ~/.claude/plugins/claude-studio
...
cp claude-studio/CLAUDE.md your-project/
...
Claude 会生成完整的规格文档到 `docs/spec.md`。

...
### 示例 2: 复杂项目
```
/takes-team "构建完整的电商后端系统"
```

### 示例 3: 问题修复
```
/takes-team "修复支付模块的高并发问题"
```
...
| 命令 | 用途 | 团队角色 |
|------|------|---------|
| `/takes-plan-review` | 计划审查 | CEO, Architect |
| `/takes-code-review` | 代码审查 | Security, Performance |
| `/takes-fro-review` | 前端审查 | GAN Evaluator |

---

**提示:** `/takes-team` 适合复杂任务，需要多个专家协同工作。对于简单任务，使用单个 Agent 更高效。
